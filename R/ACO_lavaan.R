...
#'for selection, the following decisions are needed: \enumerate{ 1. Determine
#'the target size for the short form.
#'
...
#'selects short forms with the following steps: \describe{ Step 1. All items are assigned an initial weight of 1.
#'
#'Step 2.
#'A set of n short forms is selected by sampling with probability
#'proportional to the item weights.
#'
#'Step 3.
#'Fit the latent variable model to the n short forms.
#'
#'Step 4.
#'Calculate the pheromone levels for the n short forms. Define
...
#'
#'Step 5.
#'If the pheromone level of the best short form from step 4
...
#'
#'Step 6.
#'Return to step 2 until convergence criterion is reached.
#'}
#'
