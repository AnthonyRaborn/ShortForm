...
This document was created on 2026-04-28.
...
set.seed(58310)
library(ShortForm)
##  Package 'ShortForm' version 0.5.6
...
##  Final Model Syntax:
##  
##  Ability =~ Item12 + Item54 + Item45 + Item37 + Item55 + Item39 + Item42 + Item26
##    + Item19 + Item50 + Item2 + Item44 + Item10 + Item15 + Item17
##  Outcome ~ Ability
plot(result_ACO)
...
##  Model Test User Model:
##                                                        
##    Test statistic                               762.752
##    Degrees of freedom                               740
##    P-value (Chi-square)                           0.273
##  
##  
##  Final Model Syntax:
##  Ability =~ Item33 + Item5 + Item19 + Item39 + Item42 + Item10 + Item38 + Item20
##    + Item46 + Item18 + Item36 + Item55 + Item31 + Item4 + Item35 + Item49 +
##    Item40 + Item44 + Item28 + Item24 + Item22 + Item2 + Item32 + Item1 + Item16 +
##    Item27 + Item51 + Item21 + Item13 + Item6 + Item8 + Item41 + Item43 + Item45 +
##    Item23 + Item25 + Item7 + Item52 + Item11 + Item53
plot(result_SA)
```
...
flowchart LR
    ...
    B --> C[Run Optimization Algorithm(s)]
...
- Summary statistic s for selected item sets
...
ShortForm is designed for reproducible analytical workflows: - Fully
scriptable - Compatible with R Markdown and Quarto - Supports
integration into larger modeling pipelines
