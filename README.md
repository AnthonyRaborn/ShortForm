...
##                                                        
##    Test statistic                               123.385
##    Degrees of freedom                               104
##    P-value (Chi-square)                           0.094
##  
##  
##  Final Model Syntax:
##  Ability =~ Item15 + Item16 + Item19 + Item2 + Item20 + Item30 + Item31 + Item37
##    + Item4 + Item42 + Item45 + Item50 + Item53 + Item54 + Item55
##  Outcome ~ Ability
##  
##  Fit Indices: cfi, rmsea
##  Fit Test: (cfi > 0.98)&(rmsea < 0.03)
##  Final Model Values: cfi = 0.991, rmsea = 0.014
plot(result_ACO)
```
...
##    + Item32 + Item18 + Item28 + Item34 + Item45 + Item50 + Item3 + Item25 +
##    Item2 + Item44 + Item24 + Item7 + Item22 + Item46 + Item53 + Item13 + Item39 +
##    Item38 + Item51 + Item21 + Item15 + Item56 + Item8 + Item29 + Item40 + Item26
##    + Item23 + Item47 + Item19 + Item52 + Item27 + Item9
##  
##  Criterion: "cfi" (maximized)
##  Final Model Value: 0.989
plot(result_SA)
```
...
result_TS <- tabuSearch(
  ...
  maxIterations = 10, tabu.size = 3, parallel = FALSE
)
