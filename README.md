...
This document was created on 2023-12-12.
...
##  Package 'ShortForm' version 0.5.3
...
##  Final Model Syntax:
##  
##  Trait1 =~ Item1 + Item5 + Item10 + Item9 + Item2 + Item6
##  Trait2 =~ Item17 + Item19 + Item13 + Item14 + Item22 + Item18
##  Trait3 =~ Item26 + Item25 + Item34 + Item33 + Item29 + Item32
##  Trait4 =~ Item41 + Item42 + Item37 + Item39 + Item45 + Item38
...
a total of 46.64 secs to run this example.
...
It took a total of 2.23 mins to run this example.
...
It took a total of 3.13 mins to run this example.
...
##  Model Test User Model:
##                                                        
##    Test statistic                               358.046
##    Degrees of freedom                               246
##    P-value (Chi-square)                           0.000
##  
##  
##  Final Model Syntax:
##  Trait1 =~ Item5 + Item1 + Item10 + Item9 + Item3 + Item2
##  Trait2 =~ Item14 + Item13 + Item21 + Item16 + Item22 + Item17
##  Trait3 =~ Item29 + Item34 + Item28 + Item33 + Item32 + Item25
##  Trait4 =~ Item43 + Item46 + Item40 + Item41 + Item44 + Item37
plot(SA_example) # plot showing how the fit value changes at each step
```

![](README-Simulated%20Annealing%20example-1.png)<!-- -->

It took a total of 59.36 secs to run the SA example, and a total of 7.12
