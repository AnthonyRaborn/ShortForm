...
##  Final Model Syntax:
##  
##  Trait1 =~ Item10 + Item2 + Item6 + Item1 + Item9 + Item5
##  Trait2 =~ Item18 + Item22 + Item17 + Item14 + Item13 + Item21
##  Trait3 =~ Item34 + Item33 + Item26 + Item30 + Item25 + Item29
##  Trait4 =~ Item38 + Item42 + Item41 + Item37 + Item46 + Item45
...
a total of 1.08 mins to run this example.
...
It took a total of 4.9 mins to run this example.
...
It took a total of 2.58 mins to run this example.
...
##  Model Test User Model:
##                                                        
##    Test statistic                               357.664
##    Degrees of freedom                               246
##    P-value (Chi-square)                           0.000
##  
##  
##  Final Model Syntax:
##  Trait1 =~ Item1 + Item10 + Item7 + Item11 + Item3 + Item5
##  Trait2 =~ Item13 + Item22 + Item14 + Item21 + Item19 + Item18
##  Trait3 =~ Item26 + Item33 + Item34 + Item29 + Item30 + Item28
##  Trait4 =~ Item37 + Item38 + Item39 + Item43 + Item42 + Item45
plot(SA_example) # plot showing how the fit value changes at each step
```

![](README-Simulated%20Annealing%20example-1.png)<!-- -->

It took a total of 1.1 mins to run the SA example, and a total of 9.66
