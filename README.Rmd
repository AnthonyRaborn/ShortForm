...
It took a total of `r round(as.difftime(Sys.time() - start.time.SA, units = "mins"),2)` minutes, and a total of `r round(as.difftime(Sys.time() - start.time.ACO, units = "mins"),2)` minutes to run all three together.