...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version-last-release/ShortForm)](https://cran.r-project.org/package=ShortForm) [![R-CMD-check](https://github.com/AnthonyRaborn/ShortForm/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/AnthonyRaborn/ShortForm/actions/workflows/R-CMD-check.yaml) [![CRAN Downloads Per Month](https://cranlogs.r-pkg.org/badges/ShortForm)](https://cran.r-project.org/package=ShortForm) [![CRAN Downloads Total](https://cranlogs.r-pkg.org/badges/grand-total/ShortForm?color=orange)](https://cran.r-project.org/package=ShortForm)
...
This repository includes a Dockerfile for building and checking the package in a clean R environment.

```bash
docker build -t shortform-r .
```

The Docker build installs package dependencies, builds the package source tarball, and runs R CMD check on the built package. This provides an additional reproducibility check alongside the GitHub Actions CI workflow.
